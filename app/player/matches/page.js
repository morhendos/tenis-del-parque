                    ...
                    <div className="p-4">
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex-1 bg-blue-500 text-white px-4 py-3 rounded-xl text-sm font-medium hover:bg-blue-600 transition-all transform hover:scale-105 active:scale-95 shadow-sm"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 bg-green-500 text-white px-4 py-3 rounded-xl text-sm font-medium hover:bg-green-600 transition-all transform hover:scale-105 active:scale-95 shadow-sm"
                        >
                          <svg className="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
