        ...
        <div className="lg:container lg:mx-auto lg:px-4">
          ...
          <div className="lg:grid lg:grid-cols-3 lg:gap-8 pb-12">
            ...
            <div className="lg:col-span-2 space-y-4 lg:space-y-6">
                    ...
                    {allImages.length > 1 && (
                      <>
                        ...
                        <button
                          ...
                          className="absolute left-2 lg:left-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 p-1.5 lg:p-2 rounded-full shadow-lg transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="absolute right-2 lg:right-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 p-1.5 lg:p-2 rounded-full shadow-lg transition-colors"
                        >
                          <svg className="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          {allImages.map((_, idx) => (
                            <button
                              ...
                              className={`w-2 h-2 rounded-full transition-all ${
                                selectedImage === idx ? 'bg-white w-6' : 'bg-white/60'
                              }`}
              ...
              <div className="bg-white lg:rounded-2xl shadow-lg overflow-hidden">
                ...
                <div className="lg:hidden">
                  ...
                  {/* Map Tab */}
                  {activeTab === 'map' && club.location?.coordinates && (
                    <div>
                      <div id="club-map" className="h-80"></div>
                ...
                <div className="hidden lg:block">
                  {/* Same content as before but for desktop */}
                  {/* Quick Stats */}
                  {courtInfo.total > 0 && (
                  ...
                  {/* Description, Courts, Amenities etc - Desktop version */}
                  {/* ... Previous desktop content ... */}
                </div>
              </div>
            ...
            <div className="hidden lg:block space-y-6">
              {/* Desktop contact card and other widgets */}
              {/* ... Previous desktop right column content ... */}
            </div>
          </div>
        </div>
      </section>
