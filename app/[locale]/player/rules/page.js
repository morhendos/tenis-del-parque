...
export default function PlayerRulesPage() {
  ...
  const rules = [
    {
      id: 'match-format',
      title: t.rules.matchFormat.title,
      icon: (
      ...
      content: [
        t.rules.matchFormat.points[0],
        t.rules.matchFormat.points[1],
        t.rules.matchFormat.points[2],
        t.rules.matchFormat.points[3]
      ]
    },
    {
      id: 'scoring',
      ...
      content: [
        t.rules.scoring.points[0],
        t.rules.scoring.points[1],
        t.rules.scoring.points[2],
        t.rules.scoring.points[3]
      ]
    },
    {
      id: 'court-reservation',
      title: t.rules.courtReservation.title,
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      content: [
        t.rules.courtReservation.points[0],
        t.rules.courtReservation.points[1],
        t.rules.courtReservation.points[2]
      ]
    },
    {
      id: 'conduct',
      title: t.rules.conduct.title,
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      content: [
        t.rules.conduct.points[0],
        t.rules.conduct.points[1],
        t.rules.conduct.points[2],
        t.rules.conduct.points[3]
      ]
    },
    {
      id: 'playoffs',
      title: t.rules.playoffs.title,
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      content: [
        t.rules.playoffs.points[0],
        t.rules.playoffs.points[1],
        t.rules.playoffs.points[2]
      ]
    }
  ]
