        ...
        <div className="container mx-auto">
          <div className="max-w-4xl">
            ...
            <nav className="flex items-center space-x-2 text-sm mb-6 text-white/80">
              ...
              <span>/</span>
              <Link href={`/${locale}/${locale === 'es' ? 'clubes' : 'clubs'}/${city}`} className="hover:text-white">
            ...
            {otherAreas.length > 0 && (
              <div className="flex flex-wrap gap-2">
                ...
                {otherAreas.slice(0, 4).map(otherArea => (
                  <Link
                    key={otherArea}
                    href={`/${locale}/${locale === 'es' ? 'clubes' : 'clubs'}/${city}/area/${otherArea}`}
                ...
                {otherAreas.length > 4 && (
                  <Link
                    href={`/${locale}/${locale === 'es' ? 'clubes' : 'clubs'}/${city}`}
