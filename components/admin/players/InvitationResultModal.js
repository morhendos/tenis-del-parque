...
export default function InvitationResultModal({ invitation, onClose }) {
      ...
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
          <p className="text-green-800 font-medium">
            ✅ User account created for {invitation.playerName}!
          </p>
        ...
        {process.env.NODE_ENV === 'development' && invitation.activationLink && (
          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded text-xs mb-4">
            ...
            <p className="text-yellow-700 mt-1 break-all">Direct link: {invitation.activationLink}</p>
          </div>
        )}
