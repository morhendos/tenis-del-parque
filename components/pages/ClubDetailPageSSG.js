...
export default function ClubDetailPageSSG({ locale, city, slug, clubData }) {
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-32 text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">
            {locale === 'es' ? 'Error cargando club' : 'Error loading club'}
          </h1>
        ...
        <div className="lg:container lg:mx-auto lg:px-4">
          ...
          <div className="lg:grid lg:grid-cols-3 lg:gap-8 pb-12">
            ...
            <div className="lg:col-span-2 space-y-4 lg:space-y-6">
              {/* Hero Section: Map OR Gallery (if no coordinates) */}
              {hasCoordinates ? (
                ...
                /* Gallery as Hero when no coordinates */
                ...
                /* Placeholder when no coordinates and no images */
              ...
              {/* Image Gallery - Only shown at bottom if we have coordinates (map is at top) */}
              {hasCoordinates && hasGalleryImages && (
                <div className="bg-white lg:rounded-2xl shadow-lg overflow-hidden">
                  <div className="relative aspect-[16/12] lg:aspect-[16/10]">
                    {imageLoading[selectedImage] && (
                      <div className="absolute inset-0 bg-gray-200 animate-pulse flex items-center justify-center z-10">
            ...
            <div className="hidden lg:block space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                ...
                <div className="space-y-4">
                  ...
                  {/* Google Maps quick link in contact section */}
