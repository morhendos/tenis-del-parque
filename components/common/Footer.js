...
export default function Footer({ content }) {
  return (
    <footer className="bg-white md:bg-white/80 md:backdrop-blur-sm py-6 sm:py-10 md:py-16 border-t border-gray-200">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center sm:text-left sm:flex-row sm:justify-between">
          <p className="text-gray-500 md:text-gray-600 text-sm sm:text-base md:font-light mb-4 sm:mb-0">{content.copyright}</p>
