...
export default function MatchCard({ 
  ...
  return (
    ...
    >
      ...
      {/* Schedule info - Visible for scheduled matches */}
      ...
      {/* Deadline info - Always visible for unscheduled upcoming matches */}
      {isUpcoming && !isScheduled && deadlineStatus && !isPublic && (
        <div className={`mx-3 mb-2 py-2 px-3 rounded-lg ${
      ...
      {/* Action buttons - Always visible for upcoming matches */}
        ...
        <div className="px-3 pb-3 pt-1 border-t border-gray-100">
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className={`${
                isScheduled 
                  ...
                  : 'bg-parque-purple hover:bg-purple-700'
              } text-white px-2 py-2 rounded-lg text-xs font-medium transition-all flex items-center justify-center gap-1`}
            >
            ...
            <button
              ...
              className="bg-purple-500 text-white px-2 py-2 rounded-lg text-xs font-medium hover:bg-purple-600 transition-all flex items-center justify-center gap-1"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
