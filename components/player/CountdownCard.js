  ...
  if (joined) {
    ...
    return (
      <div className="relative overflow-hidden bg-white rounded-2xl border border-gray-100 shadow-sm h-full flex flex-col">
        <div className="relative overflow-hidden bg-gradient-to-br from-parque-purple to-violet-600 px-5 py-4 text-white">
          ...
          <div className="relative flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center flex-shrink-0 shadow-md">
              <svg className="w-6 h-6 text-parque-green" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24">
