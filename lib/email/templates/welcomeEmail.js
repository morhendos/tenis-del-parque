                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin: 16px 0;">
                    <tr>
                        <td width="32%" style="padding: 0 4px 0 0;">
                            <div style="background: #f0fdf4; padding: 12px 8px; border-radius: 8px; text-align: center; border: 1px solid #a7f3d0;">
                                <div style="font-size: 24px; font-weight: 700; color: #059669;">8</div>
                                <div style="font-size: 11px; color: #065f46; margin-top: 4px;">RONDAS</div>
                            </div>
                        </td>
                        <td width="36%" style="padding: 0 4px;">
                            <div style="background: #f0fdf4; padding: 12px 8px; border-radius: 8px; text-align: center; border: 1px solid #a7f3d0;">
                                <div style="font-size: 24px; font-weight: 700; color: #059669;">1</div>
                                <div style="font-size: 11px; color: #065f46; margin-top: 4px;">PARTIDO/SEMANA</div>
                            </div>
                        </td>
                        <td width="32%" style="padding: 0 0 0 4px;">
                            <div style="background: #f0fdf4; padding: 12px 8px; border-radius: 8px; text-align: center; border: 1px solid #a7f3d0;">
                                <div style="font-size: 24px; font-weight: 700; color: #059669;">~8</div>
                                <div style="font-size: 11px; color: #065f46; margin-top: 4px;">SEMANAS</div>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin: 16px 0;">
                    <tr>
                        <td width="32%" style="padding: 0 4px 0 0;">
                            <div style="background: #f0fdf4; padding: 12px 8px; border-radius: 8px; text-align: center; border: 1px solid #a7f3d0;">
                                <div style="font-size: 24px; font-weight: 700; color: #059669;">8</div>
                                <div style="font-size: 11px; color: #065f46; margin-top: 4px;">ROUNDS</div>
                            </div>
                        </td>
                        <td width="36%" style="padding: 0 4px;">
                            <div style="background: #f0fdf4; padding: 12px 8px; border-radius: 8px; text-align: center; border: 1px solid #a7f3d0;">
                                <div style="font-size: 24px; font-weight: 700; color: #059669;">1</div>
                                <div style="font-size: 11px; color: #065f46; margin-top: 4px;">MATCH/WEEK</div>
                            </div>
                        </td>
                        <td width="32%" style="padding: 0 0 0 4px;">
                            <div style="background: #f0fdf4; padding: 12px 8px; border-radius: 8px; text-align: center; border: 1px solid #a7f3d0;">
                                <div style="font-size: 24px; font-weight: 700; color: #059669;">~8</div>
                                <div style="font-size: 11px; color: #065f46; margin-top: 4px;">WEEKS</div>
                            </div>
                        </td>
                    </tr>
                </table>
