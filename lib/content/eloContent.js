    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'En Tenis del Parque, comenzarás con un ELO base según tu nivel declarado: Principiante (1100), Intermedio (1200), o Avanzado (1300). Después de cada partido, tu ELO se ajustará basándose en el resultado y la fuerza de tu oponente.'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            rows: [
              ['Principiante', '1100', '1000-1199', 'Jugadores nuevos o casuales'],
              ['Intermedio', '1200', '1200-1299', 'Jugadores regulares con experiencia'],
              ['Avanzado', '1300', '1300+', 'Jugadores competitivos experimentados']
            ]
          },
          {
            type: 'text',
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'At Tenis del Parque, you\'ll start with a base ELO according to your declared level: Beginner (1100), Intermediate (1200), or Advanced (1300). After each match, your ELO will adjust based on the result and your opponent\'s strength.'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            rows: [
              ['Beginner', '1100', '1000-1199', 'New or casual players'],
              ['Intermediate', '1200', '1200-1299', 'Regular players with experience'],
              ['Advanced', '1300', '1300+', 'Experienced competitive players']
            ]
          },
          {
            type: 'text',
