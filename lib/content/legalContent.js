...
• **Obligación legal:** Para cumplir con requisitos fiscales y legales (Art. 6.1.c RGPD).`
        },
        {
          ...
          content: `Tus datos pueden ser compartidos con los siguientes prestadores de servicios que actúan como encargados del tratamiento:

• **Vercel Inc.** — Alojamiento web y CDN (Estados Unidos, amparado por el Marco de Privacidad de Datos UE-EE.UU.)
• **MongoDB, Inc.** — Base de datos en la nube (Estados Unidos/Europa, amparado por el Marco de Privacidad de Datos UE-EE.UU.)
• **Google LLC** — Servicios de análisis (Google Analytics) (Estados Unidos, amparado por el Marco de Privacidad de Datos UE-EE.UU.)
• **Microsoft Corporation** — Análisis de experiencia de usuario (Clarity) (Estados Unidos, amparado por el Marco de Privacidad de Datos UE-EE.UU.)
...
• **Legal obligation:** To comply with tax and legal requirements (Art. 6.1.c GDPR).`
        },
        {
          ...
          content: `Your data may be shared with the following service providers acting as data processors:

• **Vercel Inc.** — Web hosting and CDN (United States, covered by EU-US Data Privacy Framework)
• **MongoDB, Inc.** — Cloud database (United States/Europe, covered by EU-US Data Privacy Framework)
• **Google LLC** — Analytics services (Google Analytics) (United States, covered by EU-US Data Privacy Framework)
• **Microsoft Corporation** — User experience analytics (Clarity) (United States, covered by EU-US Data Privacy Framework)
