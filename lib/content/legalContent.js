...
• **NIF:** Y5805489G
• **Domicilio:** Calle Petunias de las 3, 11316 La Línea de la Concepción (Cádiz), España
...
• Copias de seguridad periódicas`
        },
        {
          ...
          content: `Si eres menor de 14 años, necesitas el consentimiento de tus padres o tutores legales para registrarte y participar en la liga. Al registrar a un menor de 14 años, el padre, madre o tutor declara haber autorizado el tratamiento de sus datos.

Podemos solicitar documentación que acredite dicha autorización. Si crees que un menor de 14 años se ha registrado sin el consentimiento adecuado, contacta con nosotros en **info@tenisdp.es** para proceder a su revisión.`
        },
        {
          id: 'cambios',
...
El organizador podrá modificar estos Términos, publicando la versión actualizada en la Web. Las modificaciones no afectarán a los derechos y obligaciones derivados de inscripciones ya formalizadas.`
        },
        {
          id: 'servicio',
...
• Comunicación de partidos y resultados por email y WhatsApp
• Fase de playoffs para los jugadores clasificados

El servicio **no incluye** la reserva ni el coste de las pistas de tenis, que serán acordados y compartidos directamente entre los jugadores emparejados. Cada jugador asume su parte del coste de la pista.`
        },
        {
          id: 'cuenta-usuario',
          title: '3. Cuenta de usuario',
          content: `Para participar en la liga, el jugador debe crear una cuenta de usuario en la plataforma. Al registrarse, el jugador se compromete a:

• Proporcionar datos veraces, completos y actualizados.
• Actualizar sus datos cada vez que cambien.
...
Los datos facilitados por el jugador se considerarán correctos. El organizador podrá eliminar cuentas que lleven más de 2 años inactivas o que incumplan estos Términos.

El jugador reconoce que la plataforma puede no estar disponible de forma ininterrumpida debido a tareas de mantenimiento o causas técnicas.`
        },
        {
          id: 'inscripcion',
          title: '4. Proceso de inscripción y pago',
          content: `Para inscribirse en una liga, el Usuario debe:

1. Crear una cuenta en la plataforma o iniciar sesión con una cuenta existente.
...
El jugador comienza a disfrutar del servicio a partir del sorteo de la primera ronda, siempre que se haya abonado el precio completo.

La inscripción tardía es posible hasta el sorteo de la segunda ronda, tras lo cual las inscripciones se cierran para esa temporada.`
        },
        {
          id: 'precios',
          title: '5. Precios',
...
**Bonificación por temporada completa:** el jugador que dispute todos sus partidos de la fase regular de una temporada recibirá un código personal e intransferible del 50% de descuento para inscribirse en la siguiente temporada. Los partidos perdidos por incomparecencia (walkover) no cuentan como disputados. El código se enviará por email al terminar la temporada y tendrá la validez indicada en dicho email.

Si así lo requiere la normativa fiscal, el organizador emitirá factura electrónica a solicitud del jugador.`
        },
        {
          id: 'desistimiento',
...
Para ejercer el derecho de desistimiento, envía un email a **info@tenisdp.es** indicando tu nombre, email de registro y el motivo de la cancelación. El reembolso se realizará en un plazo máximo de 14 días usando el mismo medio de pago utilizado en la compra.`
        ...
        {
          id: 'normas-partidos',
          title: '7. Normas de la liga y obligaciones de partido',
          content: `**Comunicación entre jugadores:**
Tras el sorteo de cada ronda, cada jugador debe ponerse en contacto con su rival lo antes posible para acordar fecha, hora y lugar del partido. La comunicación se realiza a través de la plataforma o por WhatsApp.

Si un jugador no contacta con su rival ni responde a los intentos de contacto, el organizador podrá dar el partido por perdido para el jugador inactivo o marcarlo como no disputado.

**Plazos:**
Cada ronda tiene un plazo límite para disputar el partido y registrar el resultado en la plataforma. Los plazos se comunican en la página de la liga y por email/WhatsApp. Los resultados no registrados a tiempo podrán ser decididos por el organizador.

**Registro de resultados:**
Ambos jugadores son responsables de registrar el resultado del partido en la plataforma. En caso de discrepancia, el organizador solicitará pruebas (fotos del marcador, mensajes, etc.) y tomará una decisión.

**Pistas de tenis:**
Los jugadores acuerdan entre sí el lugar del partido y comparten los costes de la pista a partes iguales, salvo acuerdo diferente entre ambos. El organizador no interviene en la reserva ni asume costes de pista.

**Categorías y niveles:**
Las ligas se organizan por niveles de juego (Oro, Plata, Bronce u otros). El jugador se inscribe en el nivel que corresponda a su habilidad. El organizador se reserva el derecho a reasignar jugadores a un nivel diferente si su rendimiento evidencia una clasificación incorrecta. Si hay pocos inscritos, el organizador podrá fusionar categorías para garantizar una competición viable.`
        },
        {
          id: 'incomparecencias',
          title: '8. Incomparecencias y costes de pista',
          content: `Si un jugador no se presenta a un partido acordado sin avisar con antelación razonable:

• El partido se registrará como **derrota por incomparecencia** (walkover) para el jugador ausente.
• El jugador ausente deberá **reembolsar al rival el coste íntegro de la reserva de pista** si esta ya había sido reservada.
• El organizador, tras recibir notificación en **info@tenisdp.es**, contactará al jugador ausente. Si no reembolsa el coste de la pista en un plazo razonable, podrá ser excluido de la liga.

Las incomparecencias reiteradas, incluso con aviso previo, podrán suponer la exclusión de la liga sin derecho a reembolso de la inscripción.

En ningún caso la incomparecencia da derecho al jugador ausente a reembolso o compensación alguna por la inscripción.`
        },
        {
          id: 'inactividad-byes',
          title: '9. Inactividad, rondas libres y byes',
          content: `**Inactividad:**
El organizador supervisará la actividad de los jugadores en cada ronda. Si un jugador no muestra actividad (no contacta con su rival, no responde a mensajes, no disputa partidos), el organizador podrá suspender temporalmente su participación. El jugador puede reactivar su participación en cualquier momento contactando al organizador, pero no tendrá derecho a reembolso parcial por las rondas perdidas.

**Byes (rondas libres):**
Cuando en una ronda haya un número impar de jugadores activos, a uno de ellos se le asignará un **bye** (ronda libre), recibiendo una victoria automática sin necesidad de jugar. El jugador que recibe el bye no tiene derecho a reembolso parcial de la inscripción.

El organizador tratará de distribuir los byes de forma equitativa para que ningún jugador reciba más de uno por temporada, salvo circunstancias excepcionales.`
        },
        {
          id: 'minimo-jugadores',
          title: '10. Número mínimo de jugadores e inicio aplazado',
          content: `Cada liga indica en su página de inscripción el número mínimo de jugadores necesario para comenzar y la fecha prevista de inicio.

Si en la fecha prevista no se alcanza el número mínimo de jugadores, el organizador podrá:

• **Aplazar el inicio** de la liga hasta reunir suficientes jugadores, informando por email de la nueva fecha.
• **Iniciar la liga con menos jugadores** de los previstos, ajustando el formato si es necesario.

En caso de aplazamiento, si el jugador no está de acuerdo con la nueva fecha, podrá solicitar el **reembolso íntegro** de su inscripción contactando a **info@tenisdp.es**.`
        },
        {
          id: 'exclusion',
          title: '11. Motivos de exclusión sin reembolso',
          content: `El organizador se reserva el derecho de excluir a un jugador de la liga **sin derecho a reembolso** en los siguientes casos:

• **Incomparecencias reiteradas** a partidos sin aviso previo y/o sin reembolsar los costes de pista al rival.
• **Comportamiento antideportivo,** agresivo, vulgar o irrespetuoso hacia otros jugadores o el organizador.
• **Falsificación de resultados** o manipulación del sistema de puntuación.
• **Uso de cuentas duplicadas** o suplantación de identidad.
• **Publicidad o spam** no autorizado a través de la plataforma.
• **Incumplimiento reiterado** de las normas de la liga o de estos Términos.

Antes de proceder a la exclusión, el organizador contactará al jugador para escuchar su versión y tratar de resolver la situación. La exclusión será el último recurso cuando no sea posible una solución.`
        },
        {
          id: 'obligaciones-usuario',
          title: '12. Obligaciones generales del usuario',
          content: `Al inscribirse, el Usuario se compromete a:

• Proporcionar información veraz y actualizada.
• Respetar las reglas de la liga.
• Mantener una conducta deportiva y respetuosa con los demás jugadores.
• Contactar con su rival y acordar los partidos dentro de los plazos establecidos.
• Registrar los resultados de los partidos en la plataforma de forma veraz y en el plazo indicado.
• Compartir equitativamente los costes de reserva de pista con su rival.
• No manipular resultados ni utilizar cuentas falsas.

El Usuario utiliza medios de comunicación a distancia para contratar el servicio. Los costes de conexión a internet o telefonía son a cargo del jugador.`
        },
        {
          id: 'obligaciones-titular',
          title: '13. Obligaciones de Tenis del Parque',
...
• Comunicar cualquier cambio relevante en el calendario o formato de la liga.

Las reclamaciones se gestionan a través de **info@tenisdp.es**. El organizador responderá en un plazo razonable e informará al jugador de la resolución.`
        },
        {
          id: 'cancelacion-liga',
          title: '14. Cancelación de la liga',
          content: `Si Tenis del Parque cancela una liga **antes de su inicio**, se procederá al reembolso íntegro de las inscripciones.

Si la cancelación se produce **una vez iniciada** la liga, se evaluará un reembolso proporcional en función de las rondas completadas.

El reembolso se realizará mediante el mismo medio de pago utilizado en la compra, en un plazo máximo de 14 días desde la comunicación de la cancelación.`
        },
        {
          id: 'limitacion',
...
• Incumplimientos o impagos entre jugadores relativos al coste de las pistas.
...
Los jugadores participan bajo su propia responsabilidad y se recomienda disponer de un seguro deportivo adecuado.`
        },
        {
          ...
          title: '16. Legislación aplicable y resolución de conflictos',
...
Si deseas presentar una reclamación, puedes contactarnos en **info@tenisdp.es**. Haremos lo posible por resolver cualquier disputa de forma amistosa antes de acudir a la vía judicial.`
        }
      ]
    }
  },
...
• **NIF:** Y5805489G
• **Address:** Calle Petunias de las 3, 11316 La Línea de la Concepción (Cádiz), Spain
• **Email:** info@tenisdp.es
...
• Regular backups`
        },
        {
          id: 'minors',
          title: '9. Minors',
          content: `If you are under 14 years of age, you need the consent of your parents or legal guardians to register and participate in the league. By registering a child under 14, the parent or guardian declares they have authorised the processing of their data.

We may request documentation to verify this authorisation. If you believe a child under 14 has registered without proper consent, please contact us at **info@tenisdp.es** so we can review the situation.`
        },
        {
          id: 'policy-changes',
...
The organiser may amend these Terms by publishing the updated version on the Website. Amendments shall not affect rights and obligations arising from registrations already completed.`
        },
        {
...
• Match and result communications via email and WhatsApp
• Playoff stage for qualifying players

The service **does not include** tennis court booking or costs, which shall be agreed upon and shared directly between paired players. Each player bears their share of court costs.`
        },
        {
          id: 'user-account',
          title: '3. User account',
          content: `To participate in the league, the player must create a user account on the platform. By registering, the player agrees to:

• Provide truthful, complete, and up-to-date information.
• Update their details whenever they change.
• Keep their login credentials (email and password) confidential.
• Not allow third parties to use their account.

The information provided by the player is deemed correct. The organiser may delete accounts that have been inactive for more than 2 years or that breach these Terms.

The player acknowledges that the platform may not be available uninterruptedly due to maintenance or technical reasons.`
        },
        {
          id: 'registration-payment',
          title: '4. Registration and payment process',
          content: `To register for a league, the User must:

1. Create an account on the platform or sign in with an existing account.
...
The player begins using the service from the draw of the first round, provided the full price has been paid.

Late registration is possible until the draw of the second round, after which registrations are closed for that season.`
        },
        {
          id: 'pricing',
          title: '5. Pricing',
...
**Full-season reward:** players who play all their regular-season matches in a season will receive a personal, non-transferable 50% discount code for the next season's registration. Matches lost by walkover do not count as played. The code will be sent by email at the end of the season and will be valid for the period stated in that email.

Where required by tax regulations, the organiser will issue an electronic invoice upon the player's request.`
        },
        {
          id: 'withdrawal',
...
To exercise your right of withdrawal, send an email to **info@tenisdp.es** stating your name, registration email, and the reason for cancellation. The refund will be processed within a maximum of 14 days using the same payment method used for the purchase.`
        ...
        {
          id: 'match-rules',
          title: '7. League rules and match obligations',
          content: `**Communication between players:**
After each round draw, each player must contact their opponent as soon as possible to agree on the date, time, and venue of the match. Communication takes place through the platform or via WhatsApp.

If a player fails to contact their opponent or respond to contact attempts, the organiser may record the match as a loss for the inactive player or mark it as unplayed.

**Deadlines:**
Each round has a deadline for playing the match and submitting the result on the platform. Deadlines are communicated on the league page and via email/WhatsApp. Results not submitted on time may be decided by the organiser.

**Submitting results:**
Both players are responsible for submitting the match result on the platform. In case of a discrepancy, the organiser will request evidence (scoreboard photos, messages, etc.) and make a decision.

**Tennis courts:**
Players agree between themselves on the match venue and share court costs equally, unless they agree otherwise. The organiser does not arrange court bookings or bear court costs.

**Categories and levels:**
Leagues are organised by playing level (Gold, Silver, Bronze, or others). Players register at the level matching their ability. The organiser reserves the right to reassign players to a different level if their performance clearly indicates an incorrect classification. If there are few registrants, the organiser may merge categories to ensure a viable competition.`
        },
        {
          id: 'no-shows',
          title: '8. No-shows and court costs',
          content: `If a player fails to attend an agreed match without giving reasonable prior notice:

• The match will be recorded as a **walkover loss** for the absent player.
• The absent player must **reimburse their opponent for the full cost of the court booking** if the court had already been reserved.
• The organiser, upon receiving a report at **info@tenisdp.es**, will contact the absent player. If the court costs are not reimbursed within a reasonable timeframe, the player may be excluded from the league.

Repeated no-shows, even with prior notice, may result in exclusion from the league without the right to a registration refund.

In no case does a no-show entitle the absent player to any refund or compensation for their registration fee.`
        },
        {
          id: 'inactivity-byes',
          title: '9. Inactivity, skipping rounds, and byes',
          content: `**Inactivity:**
The organiser will monitor player activity each round. If a player shows no activity (does not contact their opponent, does not respond to messages, does not play matches), the organiser may temporarily suspend their participation. The player may reactivate their participation at any time by contacting the organiser, but shall not be entitled to any partial refund for missed rounds.

**Byes:**
When a round has an odd number of active players, one player will be assigned a **bye**, receiving an automatic win without needing to play. The player receiving a bye is not entitled to any partial refund of their registration.

The organiser will endeavour to distribute byes fairly so that no player receives more than one per season, except in exceptional circumstances.`
        },
        {
          id: 'minimum-players',
          title: '10. Minimum number of players and delayed start',
          content: `Each league indicates on its registration page the minimum number of players required to begin and the planned start date.

If the minimum number of players is not reached by the planned start date, the organiser may:

• **Delay the start** of the league until enough players have registered, notifying players by email of the new date.
• **Start the league with fewer players** than planned, adjusting the format if necessary.

In the event of a delay, if the player does not agree with the new date, they may request a **full refund** of their registration by contacting **info@tenisdp.es**.`
        },
        {
          id: 'exclusion',
          title: '11. Grounds for exclusion without refund',
          content: `The organiser reserves the right to exclude a player from the league **without the right to a refund** in the following cases:

• **Repeated no-shows** to matches without prior notice and/or without reimbursing court costs to the opponent.
• **Unsportsmanlike, aggressive, vulgar, or disrespectful behaviour** towards other players or the organiser.
• **Falsifying results** or manipulating the scoring system.
• **Using duplicate accounts** or impersonating another person.
• **Unauthorised advertising or spam** through the platform.
• **Repeated breach** of league rules or these Terms.

Before proceeding with exclusion, the organiser will contact the player to hear their side and attempt to resolve the situation. Exclusion will be a last resort when no resolution is possible.`
        },
        {
          id: 'user-obligations',
          title: '12. General user obligations',
          content: `Upon registration, the User agrees to:

• Provide truthful and up-to-date information.
• Respect the league rules.
• Maintain sportsmanlike and respectful conduct towards other players.
• Contact their opponent and arrange matches within the established deadlines.
• Submit match results on the platform truthfully and within the indicated timeframe.
• Share court booking costs equitably with their opponent.
• Not manipulate results or use fraudulent accounts.

The User uses distance communication means to contract the service. Internet or telephone connection costs are borne by the player.`
        },
        {
          id: 'our-obligations',
          title: '13. Tenis del Parque obligations',
...
• Communicating any relevant changes to the league schedule or format.

Complaints are handled via **info@tenisdp.es**. The organiser will respond within a reasonable timeframe and inform the player of the resolution.`
        },
        {
          id: 'league-cancellation',
          title: '14. League cancellation',
          content: `If Tenis del Parque cancels a league **before it starts**, all registrations will be fully refunded.

If cancellation occurs **after the league has started**, a proportional refund based on completed rounds will be evaluated.

Refunds will be processed using the same payment method used for the purchase, within a maximum of 14 days from the cancellation notification.`
        },
        {
...
• Defaults or non-payment between players regarding court costs.
...
If you wish to file a complaint, you may contact us at **info@tenisdp.es**. We will do our best to resolve any dispute amicably before resorting to legal proceedings.`
        }
      ]
    }
  }
