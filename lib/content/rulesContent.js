    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Victoria 2-1: 2 puntos para el ganador',
          'Derrota 1-2: 1 punto para el perdedor',
          'Derrota 0-2: 0 puntos para el perdedor',
          'La clasificación se basa en: puntos totales, sets ganados, y juegos ganados',
      ...
      },
      {
        ...
        icon: 'flexibility',
        items: [
          'Cada jugador tiene 3 aplazamientos por temporada',
          'Un aplazamiento te permite extender el plazo de tu partido por 1 semana adicional',
          'Jugar a tiempo es importante para que nuestro sistema ELO y emparejamientos funcionen correctamente',
          'Los aplazamientos no se transfieren a la siguiente temporada',
          'Úsalos con moderación - ¡el sistema funciona mejor cuando todos jugamos a tiempo!'
        ]
      },
      {
        id: 'conduct',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          '2-1 victory: 2 points for winner',
          '1-2 loss: 1 point for loser',
          '0-2 loss: 0 points for loser',
          'Ranking based on: total points, sets won, and games won',
      ...
      },
      {
        ...
        icon: 'flexibility',
        items: [
          'Each player has 3 postponements per season',
          'A postponement lets you extend your match deadline by 1 additional week',
          'Playing on time is important for our ELO and pairing system to work correctly',
          'Postponements do not transfer to next season',
          'Use them wisely - the system works best when everyone plays on time!'
        ]
      },
      {
        id: 'conduct',
