export const homeContent = {
  es: {
    ...
    hero: {
      badge: '🚀 ¡COMIENZA EL LUNES 7 DE JULIO!',
      title: 'Compite. Mejora. Disfruta.',
      tagline: 'La primera liga de tenis amateur en Sotogrande arranca el LUNES 7 DE JULIO. ¡Últimas horas para inscribirse!',
      cta: '¡Inscríbete AHORA!',
      stats: [
        { number: 'LUN 7', label: 'Inicio liga' },
        { number: 'DOM 6', label: 'Emparejamientos' },
    ...
    howItWorks: {
      title: 'Cómo funciona',
      subtitle: 'Simple, flexible y diseñado para ti. ¡ARRANCAMOS EL LUNES 7 DE JULIO!',
      steps: [
        {
          title: 'Inscríbete HOY',
          description: 'Elige tu nivel: principiante, intermedio o avanzado. Gratis para la primera temporada. ¡La liga comienza el LUNES 7 DE JULIO! Últimas horas para inscribirse.'
        },
        {
          title: 'Recibe tu emparejamiento',
          description: 'Este DOMINGO 6 de julio recibirás tu primer oponente. Contacta y acuerda el horario para jugar durante la semana.'
        },
        {
      ...
      items: [
        {
          ...
          a: '¡La liga comienza el LUNES 7 DE JULIO! Ya tenemos suficientes jugadores registrados y estamos listos para arrancar. Los primeros emparejamientos se enviarán este DOMINGO 6 de julio por la noche.'
        },
        {
    ...
    signup: {
      ...
      subtitle: 'La liga comienza el LUNES 7 DE JULIO. Los emparejamientos se envían este DOMINGO 6 de julio. ¡Esta es tu última oportunidad! ¡Primera temporada gratis!',
      form: {
      ...
      success: {
        ...
        message: '¡Ya estás dentro! Recibirás tu primer oponente este DOMINGO 6 de julio por la noche. ¡La liga comienza el LUNES 7 DE JULIO!'
      }
    },
    footer: {
  ...
  en: {
    ...
    hero: {
      badge: '🚀 STARTING MONDAY JULY 7TH!',
      title: 'Play. Progress. Enjoy.',
      tagline: 'The first amateur tennis league in Sotogrande launches MONDAY JULY 7TH. Last hours to register!',
      cta: 'SIGN UP NOW!',
      stats: [
        { number: 'MON 7', label: 'League starts' },
        { number: 'SUN 6', label: 'Pairings out' },
    ...
    howItWorks: {
      title: 'How it works',
      subtitle: 'Simple, flexible, and designed for you. LAUNCHING MONDAY JULY 7TH!',
      steps: [
        {
          title: 'Sign up TODAY',
          description: 'Choose your level: beginner, intermediate, or advanced. Free for the first season. The league starts MONDAY JULY 7TH! Last hours to register.'
        },
        {
          title: 'Get matched',
          description: 'This SUNDAY July 6th you\'ll receive your first opponent. Contact and agree on time to play during the week.'
        },
        {
      ...
      items: [
        {
          ...
          a: 'The league starts MONDAY JULY 7TH! We have enough registered players and are ready to launch. First round pairings will be sent out this SUNDAY July 6th evening.'
        },
        {
    ...
    signup: {
      ...
      subtitle: 'The league starts MONDAY JULY 7TH. Pairings go out this SUNDAY July 6th. This is your final chance! First season free!',
      form: {
        name: 'Full name',
        email: 'Email',
        whatsapp: 'WhatsApp',
      ...
      success: {
        ...
        message: "You're in! You'll receive your first opponent this SUNDAY July 6th evening. The league starts MONDAY JULY 7TH!"
      }
    },
    footer: {
