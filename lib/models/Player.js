...
const PlayerSchema = new mongoose.Schema({
  ...
  email: {
    ...
    // REMOVED: unique: true, // 🔧 TEMP FIX: Allow same email across different leagues
    lowercase: true,
    trim: true,
...
// 🔧 TEMP FIX: Prevent duplicate registrations per league/season
// This replaces the global email uniqueness with league-specific uniqueness
PlayerSchema.index({ email: 1, league: 1, season: 1 }, { unique: true })
