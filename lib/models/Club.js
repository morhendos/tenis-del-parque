...
const ClubSchema = new mongoose.Schema({
  ...
  location: {
    ...
    city: {
      type: String,
      required: true,
      enum: ['malaga', 'marbella', 'estepona', 'sotogrande', 'mijas', 'benalmadena', 'fuengirola', 'torremolinos', 'manilva', 'casares']
    },
    postalCode: String,
    coordinates: {
      lat: {
...
// Removed duplicate index on googlePlaceId - it's already defined in the schema
