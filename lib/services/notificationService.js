...
function buildEmailHtml(subject, body, locale) {
  ...
  return '<!DOCTYPE html>'
    ...
    + '<img src="' + logoUrl + '" alt="Tenis del Parque" style="height: 52px; width: auto;" />'
    + '</td></tr>'
    ...
    + '<h1 style="color: white; margin: 0; font-size: 20px; font-weight: 700; letter-spacing: 0.3px;">' + subject + '</h1>'
    + '</td></tr>'
    // Content
